...
export default function FirstSection() {
   ...
   <p className="lg:text-3xl text-gray-600 mt-4">Unique dresses</p>
   ...
   <p className="lg:text-3xl text-gray-600 mt-4">Party-perfect blouses</p>
   ...
   <p className="lg:text-3xl text-gray-600 mt-4">Creative cardigans</p>
